...
subroutine qlm_output_vtk (CCTK_ARGUMENTS, hn, file_name)
  ...
  call writescalar_complex ('m0', cmplx(qlm_m0r(:,:,hn), qlm_m0i(:,:,hn), kind=8))
  call writescalar_complex ('m1', cmplx(qlm_m1r(:,:,hn), qlm_m1i(:,:,hn), kind=8))
  call writescalar_complex ('m2', cmplx(qlm_m2r(:,:,hn), qlm_m2i(:,:,hn), kind=8))
  call writescalar_complex ('m3', cmplx(qlm_m3r(:,:,hn), qlm_m3i(:,:,hn), kind=8))
