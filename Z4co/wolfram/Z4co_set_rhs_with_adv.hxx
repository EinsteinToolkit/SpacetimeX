/* Z4co_set_rhs_with_adv.hxx */
/* Produced with Mathematica */

#ifndef Z4CO_SET_RHS_WITH_ADV_HXX
#define Z4CO_SET_RHS_WITH_ADV_HXX
...
beta1*dchi1 + beta2*dchi2 + beta3*dchi3 - 
...
beta1*dexAt111 + beta2*dexAt211 + beta3*dexAt311 + (4*dbeta11*exAt11)/3. - 
  (2*dbeta22*exAt11)/3. - (2*dbeta33*exAt11)/3. + 2*dbeta12*exAt12 + 
  2*dbeta13*exAt13 + alpha*exAt11*exKh - 2*alpha*Power(exAt11,2)*invgamt11 - 
  4*alpha*exAt11*exAt12*invgamt12 - 4*alpha*exAt11*exAt13*invgamt13 - 
  2*alpha*Power(exAt12,2)*invgamt22 - 4*alpha*exAt12*exAt13*invgamt23 - 
  2*alpha*Power(exAt13,2)*invgamt33 + 
  (chi*(DDalpha11*(-3 + gam11*invgam11) + 2*DDalpha12*gam11*invgam12 + 
   ...
   3. + 2*alpha*exAt11*Theta
);

local_dtexAt12.store(mask, index2, 
beta1*dexAt112 + beta2*dexAt212 + beta3*dexAt312 + dbeta21*exAt11 + 
  (dbeta11*exAt12)/3. + (dbeta22*exAt12)/3. - (2*dbeta33*exAt12)/3. + 
  dbeta23*exAt13 + dbeta12*exAt22 + dbeta13*exAt23 + alpha*exAt12*exKh - 
  2*alpha*exAt11*exAt12*invgamt11 - 2*alpha*Power(exAt12,2)*invgamt12 - 
  2*alpha*exAt11*exAt22*invgamt12 - 2*alpha*exAt12*exAt13*invgamt13 - 
  2*alpha*exAt11*exAt23*invgamt13 - 2*alpha*exAt12*exAt22*invgamt22 - 
  2*alpha*exAt13*exAt22*invgamt23 - 2*alpha*exAt12*exAt23*invgamt23 - 
  2*alpha*exAt13*exAt23*invgamt33 + 
  (chi*(DDalpha11*gam12*invgam11 + DDalpha12*(-3 + 2*gam12*invgam12) + 
   ...
   3. + 2*alpha*exAt12*Theta
);

local_dtexAt13.store(mask, index2, 
beta1*dexAt113 + beta2*dexAt213 + beta3*dexAt313 + dbeta31*exAt11 + 
  dbeta32*exAt12 + (dbeta11*exAt13)/3. - (2*dbeta22*exAt13)/3. + 
  (dbeta33*exAt13)/3. + dbeta12*exAt23 + dbeta13*exAt33 + 
  alpha*exAt13*exKh - 2*alpha*exAt11*exAt13*invgamt11 - 
  2*alpha*exAt12*exAt13*invgamt12 - 2*alpha*exAt11*exAt23*invgamt12 - 
  2*alpha*Power(exAt13,2)*invgamt13 - 2*alpha*exAt11*exAt33*invgamt13 - 
  2*alpha*exAt12*exAt23*invgamt22 - 2*alpha*exAt13*exAt23*invgamt23 - 
  2*alpha*exAt12*exAt33*invgamt23 - 2*alpha*exAt13*exAt33*invgamt33 + 
  (chi*(DDalpha11*gam13*invgam11 + 2*DDalpha12*gam13*invgam12 + 
   ...
   3. + 2*alpha*exAt13*Theta
);

local_dtexAt22.store(mask, index2, 
beta1*dexAt122 + beta2*dexAt222 + beta3*dexAt322 + 2*dbeta21*exAt12 - 
  (2*dbeta11*exAt22)/3. + (4*dbeta22*exAt22)/3. - (2*dbeta33*exAt22)/3. + 
  2*dbeta23*exAt23 + alpha*exAt22*exKh - 2*alpha*Power(exAt12,2)*invgamt11 - 
  4*alpha*exAt12*exAt22*invgamt12 - 4*alpha*exAt12*exAt23*invgamt13 - 
  2*alpha*Power(exAt22,2)*invgamt22 - 4*alpha*exAt22*exAt23*invgamt23 - 
  2*alpha*Power(exAt23,2)*invgamt33 + 
  (chi*(DDalpha11*gam22*invgam11 + 2*DDalpha12*gam22*invgam12 + 
   ...
   3. + 2*alpha*exAt22*Theta
);

local_dtexAt23.store(mask, index2, 
beta1*dexAt123 + beta2*dexAt223 + beta3*dexAt323 + dbeta31*exAt12 + 
  dbeta21*exAt13 + dbeta32*exAt22 - (2*dbeta11*exAt23)/3. + 
  (dbeta22*exAt23)/3. + (dbeta33*exAt23)/3. + dbeta23*exAt33 + 
  alpha*exAt23*exKh - 2*alpha*exAt12*exAt13*invgamt11 - 
  2*alpha*exAt13*exAt22*invgamt12 - 2*alpha*exAt12*exAt23*invgamt12 - 
  2*alpha*exAt13*exAt23*invgamt13 - 2*alpha*exAt12*exAt33*invgamt13 - 
  2*alpha*exAt22*exAt23*invgamt22 - 2*alpha*Power(exAt23,2)*invgamt23 - 
  2*alpha*exAt22*exAt33*invgamt23 - 2*alpha*exAt23*exAt33*invgamt33 + 
  (chi*(DDalpha11*gam23*invgam11 + 2*DDalpha12*gam23*invgam12 + 
   ...
   3. + 2*alpha*exAt23*Theta
);

local_dtexAt33.store(mask, index2, 
beta1*dexAt133 + beta2*dexAt233 + beta3*dexAt333 + 2*dbeta31*exAt13 + 
  2*dbeta32*exAt23 - (2*dbeta11*exAt33)/3. - (2*dbeta22*exAt33)/3. + 
  (4*dbeta33*exAt33)/3. + alpha*exAt33*exKh - 
  2*alpha*Power(exAt13,2)*invgamt11 - 4*alpha*exAt13*exAt23*invgamt12 - 
  4*alpha*exAt13*exAt33*invgamt13 - 2*alpha*Power(exAt23,2)*invgamt22 - 
  4*alpha*exAt23*exAt33*invgamt23 - 2*alpha*Power(exAt33,2)*invgamt33 + 
  (chi*(DDalpha11*gam33*invgam11 + 2*DDalpha12*gam33*invgam12 + 
       ...
       8*alpha*cpi*gam33*invgam33*Ss33))/3. + 2*alpha*exAt33*Theta
);

local_dttrGt1.store(mask, index2, 
(3*beta1*dtrGt11 + 3*beta2*dtrGt21 + 3*beta3*dtrGt31 - 6*dalpha1*exAtUU11 - 
    (9*alpha*dchi1*exAtUU11)/chi - 6*dalpha2*exAtUU12 - 
    (9*alpha*dchi2*exAtUU12)/chi - 6*dalpha3*exAtUU13 - 
    (9*alpha*dchi3*exAtUU13)/chi + 6*alpha*exAtUU11*Gt111 + 
    12*alpha*exAtUU12*Gt112 + 12*alpha*exAtUU13*Gt113 + 
    6*alpha*exAtUU22*Gt122 + 12*alpha*exAtUU23*Gt123 + 
    6*alpha*exAtUU33*Gt133 + 3*ddbeta111*invgamt11 + 
    (ddbeta111 + ddbeta122 + ddbeta133)*invgamt11 - 
    4*alpha*dexKh1*invgamt11 - 2*alpha*dTheta1*invgamt11 + 
    6*ddbeta121*invgamt12 + (ddbeta121 + ddbeta222 + ddbeta233)*invgamt12 - 
    4*alpha*dexKh2*invgamt12 - 2*alpha*dTheta2*invgamt12 + 
    6*ddbeta131*invgamt13 + (ddbeta131 + ddbeta232 + ddbeta333)*invgamt13 - 
    4*alpha*dexKh3*invgamt13 - 2*alpha*dTheta3*invgamt13 + 
    ...
    6*alpha*ckappa1*trGtd1 - 3*dbeta11*trGtd1 + 
    2*(dbeta11 + dbeta22 + dbeta33)*trGtd1 - 3*dbeta21*trGtd2 - 
    3*dbeta31*trGtd3)/3.
);

local_dttrGt2.store(mask, index2, 
(3*beta1*dtrGt12 + 3*beta2*dtrGt22 + 3*beta3*dtrGt32 - 6*dalpha1*exAtUU12 - 
    (9*alpha*dchi1*exAtUU12)/chi - 6*dalpha2*exAtUU22 - 
    (9*alpha*dchi2*exAtUU22)/chi - 6*dalpha3*exAtUU23 - 
    (9*alpha*dchi3*exAtUU23)/chi + 6*alpha*exAtUU11*Gt211 + 
    12*alpha*exAtUU12*Gt212 + 12*alpha*exAtUU13*Gt213 + 
    6*alpha*exAtUU22*Gt222 + 12*alpha*exAtUU23*Gt223 + 
    6*alpha*exAtUU33*Gt233 + 3*ddbeta112*invgamt11 + 
    6*ddbeta122*invgamt12 + (ddbeta111 + ddbeta122 + ddbeta133)*invgamt12 - 
    4*alpha*dexKh1*invgamt12 - 2*alpha*dTheta1*invgamt12 + 
    6*ddbeta132*invgamt13 + 3*ddbeta222*invgamt22 + 
    (ddbeta121 + ddbeta222 + ddbeta233)*invgamt22 - 
    4*alpha*dexKh2*invgamt22 - 2*alpha*dTheta2*invgamt22 + 
    6*ddbeta232*invgamt23 + (ddbeta131 + ddbeta232 + ddbeta333)*invgamt23 - 
    ...
    3*dbeta22*trGtd2 + 2*(dbeta11 + dbeta22 + dbeta33)*trGtd2 - 
    3*dbeta32*trGtd3)/3.
);

local_dttrGt3.store(mask, index2, 
(3*beta1*dtrGt13 + 3*beta2*dtrGt23 + 3*beta3*dtrGt33 - 6*dalpha1*exAtUU13 - 
    (9*alpha*dchi1*exAtUU13)/chi - 6*dalpha2*exAtUU23 - 
    (9*alpha*dchi2*exAtUU23)/chi - 6*dalpha3*exAtUU33 - 
    (9*alpha*dchi3*exAtUU33)/chi + 6*alpha*exAtUU11*Gt311 + 
    ...
    6*ddbeta123*invgamt12 + 6*ddbeta133*invgamt13 + 
    (ddbeta111 + ddbeta122 + ddbeta133)*invgamt13 - 
    4*alpha*dexKh1*invgamt13 - 2*alpha*dTheta1*invgamt13 + 
    3*ddbeta223*invgamt22 + 6*ddbeta233*invgamt23 + 
    (ddbeta121 + ddbeta222 + ddbeta233)*invgamt23 - 
    4*alpha*dexKh2*invgamt23 - 2*alpha*dTheta2*invgamt23 + 
    3*ddbeta333*invgamt33 + (ddbeta131 + ddbeta232 + ddbeta333)*invgamt33 - 
    ...
    3*dbeta23*trGtd2 + 6*alpha*ckappa1*trGtd3 - 3*dbeta33*trGtd3 + 
    2*(dbeta11 + dbeta22 + dbeta33)*trGtd3)/3.
);
...
#endif // #ifndef Z4CO_SET_RHS_WITH_ADV_HXX
