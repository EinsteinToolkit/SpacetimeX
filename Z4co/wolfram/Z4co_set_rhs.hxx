...
vreal &gamt11 = gf_gamt(mask, index5)(0,0);
vreal &gamt12 = gf_gamt(mask, index5)(0,1);
vreal &gamt13 = gf_gamt(mask, index5)(0,2);
vreal &gamt22 = gf_gamt(mask, index5)(1,1);
vreal &gamt23 = gf_gamt(mask, index5)(1,2);
vreal &gamt33 = gf_gamt(mask, index5)(2,2);
vreal &exKh = gf_exKh(mask, index5);
vreal &exAt11 = gf_exAt(mask, index5)(0,0);
vreal &exAt12 = gf_exAt(mask, index5)(0,1);
vreal &exAt13 = gf_exAt(mask, index5)(0,2);
vreal &exAt22 = gf_exAt(mask, index5)(1,1);
vreal &exAt23 = gf_exAt(mask, index5)(1,2);
vreal &exAt33 = gf_exAt(mask, index5)(2,2);
vreal &trGt1 = gf_trGt(mask, index5)(0);
vreal &trGt2 = gf_trGt(mask, index5)(1);
vreal &trGt3 = gf_trGt(mask, index5)(2);
vreal &Theta = gf_Theta(mask, index5);
vreal &alpha = gf_alpha(mask, index5);
vreal &beta1 = gf_beta(mask, index5)(0);
vreal &beta2 = gf_beta(mask, index5)(1);
vreal &beta3 = gf_beta(mask, index5)(2);
vreal &dchi1 = gf_dchi(mask, index5)(0);
vreal &dchi2 = gf_dchi(mask, index5)(1);
vreal &dchi3 = gf_dchi(mask, index5)(2);
vreal &dgamt111 = gf_dgamt(mask, index5)(0,0)(0);
vreal &dgamt112 = gf_dgamt(mask, index5)(0,1)(0);
vreal &dgamt113 = gf_dgamt(mask, index5)(0,2)(0);
vreal &dgamt122 = gf_dgamt(mask, index5)(1,1)(0);
vreal &dgamt123 = gf_dgamt(mask, index5)(1,2)(0);
vreal &dgamt133 = gf_dgamt(mask, index5)(2,2)(0);
vreal &dgamt211 = gf_dgamt(mask, index5)(0,0)(1);
vreal &dgamt212 = gf_dgamt(mask, index5)(0,1)(1);
vreal &dgamt213 = gf_dgamt(mask, index5)(0,2)(1);
vreal &dgamt222 = gf_dgamt(mask, index5)(1,1)(1);
vreal &dgamt223 = gf_dgamt(mask, index5)(1,2)(1);
vreal &dgamt233 = gf_dgamt(mask, index5)(2,2)(1);
vreal &dgamt311 = gf_dgamt(mask, index5)(0,0)(2);
vreal &dgamt312 = gf_dgamt(mask, index5)(0,1)(2);
vreal &dgamt313 = gf_dgamt(mask, index5)(0,2)(2);
vreal &dgamt322 = gf_dgamt(mask, index5)(1,1)(2);
vreal &dgamt323 = gf_dgamt(mask, index5)(1,2)(2);
vreal &dgamt333 = gf_dgamt(mask, index5)(2,2)(2);
vreal &dexKh1 = gf_dexKh(mask, index5)(0);
vreal &dexKh2 = gf_dexKh(mask, index5)(1);
vreal &dexKh3 = gf_dexKh(mask, index5)(2);
vreal &dexAt111 = gf_dexAt(mask, index5)(0,0)(0);
vreal &dexAt112 = gf_dexAt(mask, index5)(0,1)(0);
vreal &dexAt113 = gf_dexAt(mask, index5)(0,2)(0);
vreal &dexAt122 = gf_dexAt(mask, index5)(1,1)(0);
vreal &dexAt123 = gf_dexAt(mask, index5)(1,2)(0);
vreal &dexAt133 = gf_dexAt(mask, index5)(2,2)(0);
vreal &dexAt211 = gf_dexAt(mask, index5)(0,0)(1);
vreal &dexAt212 = gf_dexAt(mask, index5)(0,1)(1);
vreal &dexAt213 = gf_dexAt(mask, index5)(0,2)(1);
vreal &dexAt222 = gf_dexAt(mask, index5)(1,1)(1);
vreal &dexAt223 = gf_dexAt(mask, index5)(1,2)(1);
vreal &dexAt233 = gf_dexAt(mask, index5)(2,2)(1);
vreal &dexAt311 = gf_dexAt(mask, index5)(0,0)(2);
vreal &dexAt312 = gf_dexAt(mask, index5)(0,1)(2);
vreal &dexAt313 = gf_dexAt(mask, index5)(0,2)(2);
vreal &dexAt322 = gf_dexAt(mask, index5)(1,1)(2);
vreal &dexAt323 = gf_dexAt(mask, index5)(1,2)(2);
vreal &dexAt333 = gf_dexAt(mask, index5)(2,2)(2);
vreal &dtrGt11 = gf_dtrGt(mask, index5)(0)(0);
vreal &dtrGt12 = gf_dtrGt(mask, index5)(1)(0);
vreal &dtrGt13 = gf_dtrGt(mask, index5)(2)(0);
vreal &dtrGt21 = gf_dtrGt(mask, index5)(0)(1);
vreal &dtrGt22 = gf_dtrGt(mask, index5)(1)(1);
vreal &dtrGt23 = gf_dtrGt(mask, index5)(2)(1);
vreal &dtrGt31 = gf_dtrGt(mask, index5)(0)(2);
vreal &dtrGt32 = gf_dtrGt(mask, index5)(1)(2);
vreal &dtrGt33 = gf_dtrGt(mask, index5)(2)(2);
vreal &dTheta1 = gf_dTheta(mask, index5)(0);
vreal &dTheta2 = gf_dTheta(mask, index5)(1);
vreal &dTheta3 = gf_dTheta(mask, index5)(2);
vreal &dalpha1 = gf_dalpha(mask, index5)(0);
vreal &dalpha2 = gf_dalpha(mask, index5)(1);
vreal &dalpha3 = gf_dalpha(mask, index5)(2);
vreal &dbeta11 = gf_dbeta(mask, index5)(0)(0);
vreal &dbeta12 = gf_dbeta(mask, index5)(1)(0);
vreal &dbeta13 = gf_dbeta(mask, index5)(2)(0);
vreal &dbeta21 = gf_dbeta(mask, index5)(0)(1);
vreal &dbeta22 = gf_dbeta(mask, index5)(1)(1);
vreal &dbeta23 = gf_dbeta(mask, index5)(2)(1);
vreal &dbeta31 = gf_dbeta(mask, index5)(0)(2);
vreal &dbeta32 = gf_dbeta(mask, index5)(1)(2);
vreal &dbeta33 = gf_dbeta(mask, index5)(2)(2);
vreal &ddchi11 = gf_ddchi(mask, index5)(0,0);
vreal &ddchi12 = gf_ddchi(mask, index5)(0,1);
vreal &ddchi13 = gf_ddchi(mask, index5)(0,2);
vreal &ddchi22 = gf_ddchi(mask, index5)(1,1);
vreal &ddchi23 = gf_ddchi(mask, index5)(1,2);
vreal &ddchi33 = gf_ddchi(mask, index5)(2,2);
vreal &ddgamt1111 = gf_ddgamt(mask, index5)(0,0)(0,0);
vreal &ddgamt1112 = gf_ddgamt(mask, index5)(0,1)(0,0);
vreal &ddgamt1113 = gf_ddgamt(mask, index5)(0,2)(0,0);
vreal &ddgamt1122 = gf_ddgamt(mask, index5)(1,1)(0,0);
vreal &ddgamt1123 = gf_ddgamt(mask, index5)(1,2)(0,0);
vreal &ddgamt1133 = gf_ddgamt(mask, index5)(2,2)(0,0);
vreal &ddgamt1211 = gf_ddgamt(mask, index5)(0,0)(0,1);
vreal &ddgamt1212 = gf_ddgamt(mask, index5)(0,1)(0,1);
vreal &ddgamt1213 = gf_ddgamt(mask, index5)(0,2)(0,1);
vreal &ddgamt1222 = gf_ddgamt(mask, index5)(1,1)(0,1);
vreal &ddgamt1223 = gf_ddgamt(mask, index5)(1,2)(0,1);
vreal &ddgamt1233 = gf_ddgamt(mask, index5)(2,2)(0,1);
vreal &ddgamt1311 = gf_ddgamt(mask, index5)(0,0)(0,2);
vreal &ddgamt1312 = gf_ddgamt(mask, index5)(0,1)(0,2);
vreal &ddgamt1313 = gf_ddgamt(mask, index5)(0,2)(0,2);
vreal &ddgamt1322 = gf_ddgamt(mask, index5)(1,1)(0,2);
vreal &ddgamt1323 = gf_ddgamt(mask, index5)(1,2)(0,2);
vreal &ddgamt1333 = gf_ddgamt(mask, index5)(2,2)(0,2);
vreal &ddgamt2211 = gf_ddgamt(mask, index5)(0,0)(1,1);
vreal &ddgamt2212 = gf_ddgamt(mask, index5)(0,1)(1,1);
vreal &ddgamt2213 = gf_ddgamt(mask, index5)(0,2)(1,1);
vreal &ddgamt2222 = gf_ddgamt(mask, index5)(1,1)(1,1);
vreal &ddgamt2223 = gf_ddgamt(mask, index5)(1,2)(1,1);
vreal &ddgamt2233 = gf_ddgamt(mask, index5)(2,2)(1,1);
vreal &ddgamt2311 = gf_ddgamt(mask, index5)(0,0)(1,2);
vreal &ddgamt2312 = gf_ddgamt(mask, index5)(0,1)(1,2);
vreal &ddgamt2313 = gf_ddgamt(mask, index5)(0,2)(1,2);
vreal &ddgamt2322 = gf_ddgamt(mask, index5)(1,1)(1,2);
vreal &ddgamt2323 = gf_ddgamt(mask, index5)(1,2)(1,2);
vreal &ddgamt2333 = gf_ddgamt(mask, index5)(2,2)(1,2);
vreal &ddgamt3311 = gf_ddgamt(mask, index5)(0,0)(2,2);
vreal &ddgamt3312 = gf_ddgamt(mask, index5)(0,1)(2,2);
vreal &ddgamt3313 = gf_ddgamt(mask, index5)(0,2)(2,2);
vreal &ddgamt3322 = gf_ddgamt(mask, index5)(1,1)(2,2);
vreal &ddgamt3323 = gf_ddgamt(mask, index5)(1,2)(2,2);
vreal &ddgamt3333 = gf_ddgamt(mask, index5)(2,2)(2,2);
vreal &ddalpha11 = gf_ddalpha(mask, index5)(0,0);
vreal &ddalpha12 = gf_ddalpha(mask, index5)(0,1);
vreal &ddalpha13 = gf_ddalpha(mask, index5)(0,2);
vreal &ddalpha22 = gf_ddalpha(mask, index5)(1,1);
vreal &ddalpha23 = gf_ddalpha(mask, index5)(1,2);
vreal &ddalpha33 = gf_ddalpha(mask, index5)(2,2);
vreal &ddbeta111 = gf_ddbeta(mask, index5)(0)(0,0);
vreal &ddbeta112 = gf_ddbeta(mask, index5)(1)(0,0);
vreal &ddbeta113 = gf_ddbeta(mask, index5)(2)(0,0);
vreal &ddbeta121 = gf_ddbeta(mask, index5)(0)(0,1);
vreal &ddbeta122 = gf_ddbeta(mask, index5)(1)(0,1);
vreal &ddbeta123 = gf_ddbeta(mask, index5)(2)(0,1);
vreal &ddbeta131 = gf_ddbeta(mask, index5)(0)(0,2);
vreal &ddbeta132 = gf_ddbeta(mask, index5)(1)(0,2);
vreal &ddbeta133 = gf_ddbeta(mask, index5)(2)(0,2);
vreal &ddbeta221 = gf_ddbeta(mask, index5)(0)(1,1);
vreal &ddbeta222 = gf_ddbeta(mask, index5)(1)(1,1);
vreal &ddbeta223 = gf_ddbeta(mask, index5)(2)(1,1);
vreal &ddbeta231 = gf_ddbeta(mask, index5)(0)(1,2);
vreal &ddbeta232 = gf_ddbeta(mask, index5)(1)(1,2);
vreal &ddbeta233 = gf_ddbeta(mask, index5)(2)(1,2);
vreal &ddbeta331 = gf_ddbeta(mask, index5)(0)(2,2);
vreal &ddbeta332 = gf_ddbeta(mask, index5)(1)(2,2);
vreal &ddbeta333 = gf_ddbeta(mask, index5)(2)(2,2);
