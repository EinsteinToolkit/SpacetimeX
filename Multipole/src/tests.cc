...
CCTK_REAL integration_convergence_order(
    CCTK_REAL (*integration_fn)(const CCTK_REAL *, int, int, CCTK_REAL,
                                CCTK_REAL),
...
void Multipole_TestIntegrationConvergence(CCTK_ARGUMENTS) {
  ...
  *test_trapezoidal_convergence_order = integration_convergence_order(
      &Trapezoidal2DIntegral, test_trapezoidal_result_low,
...
void Multipole_TestIntegrationSymmetry(CCTK_ARGUMENTS) {
  ...
  *test_simpson_pi_symmetry =
      test_pi_symmetric_sphere_integral(&Simpson2DIntegral, 0);
  *test_midpoint_pi_symmetry =
      test_pi_symmetric_sphere_integral(&Midpoint2DIntegral, 1);
  *test_trapezoidal_pi_symmetry =
      test_pi_symmetric_sphere_integral(&Trapezoidal2DIntegral, 0);
  *test_driscollhealy_pi_symmetry =
      test_pi_symmetric_sphere_integral(&DriscollHealy2DIntegral, 0);
