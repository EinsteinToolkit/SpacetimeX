...
extern "C" void Z4coo_Constraints(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTS_Z4coo_Constraints;
...
#ifdef __CUDACC__
  const nvtxRangeId_t range = nvtxRangeStartA("Z4coo_Constraints::constraints");
#endif

#include "../wolfram/Z4coo_set_constraint.hxx"
