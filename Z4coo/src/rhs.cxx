...
extern "C" void Z4coo_RHS(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTS_Z4coo_RHS;
...
#ifdef __CUDACC__
  const nvtxRangeId_t range = nvtxRangeStartA("Z4coo_RHS::rhs");
#endif

#include "../wolfram/Z4coo_set_rhs.hxx"
